...
# 查询时间范围
start_time = '2025-05-29T18:00:00Z'
stop_time = '2025-06-13T15:00:00Z'

# 正磷酸盐（进水格栅） 单位mg/L  MW2128  新增加点位
# 正磷酸盐（二次提升） 单位mg/L  MW2129  新增加点位
...
from(bucket: "{bucket}")
  ...
  |> filter(fn: (r) => r.pos == "MW2123" or r.pos == "MW2124" or r.pos 
  == "MW2125" or r.pos == "MW2126" or r.pos == "MW836" or r.pos == "MW832" or 
  r.pos == "MW837" or r.pos == "MW829"or r.pos == "MW2000" or r.pos == "MW664" or r.pos == "MW2130" 
  or r.pos == "TC1_SDS_EFFTP" or r.pos == "MW2129" or r.pos == "EM231124040001" or r.pos == "EM231124040002" 
  or r.pos == "EM240614150001" or r.pos == "EM240614150002"or r.pos == "MW838" or r.pos == "MW834" or r.pos == "MW833")
  |> window(every: 30m)
  |> max()
  |> pivot(rowKey: ["_start"], columnKey: ["pos"], valueColumn: "_value")
  |> keep(columns: ["_start", "MW2123", "MW2124", "MW2125", "MW2126", "MW836", "MW832", "MW837", 
  "MW829","MW2000", "MW664", "MW2130","TC1_SDS_EFFTP", "MW2129", "EM231124040001", "EM231124040002", 
  "EM240614150001", "EM240614150002", "MW838", "MW834", "MW833"])
"""
...
with InfluxDBClient(url=url, token=token, org=org) as client:
    try:
        ...
        for table in result:
            for record in table.records:
                ...
                data.append({
                    ...
                    "PAC2": record.values.get("MW2124", 0),
                    "PAM1": record.values.get("MW2125", 0),
                    "PAM2": record.values.get("MW2126", 0),
                    "influent_TP": record.values.get("MW2130", 0),
                    ...
                    "OxidationDitch2#": record.values.get("MW2000", 0),
                    ...
                    "Effluent_TN":record.values.get("MW838", 0),
                    "Effluent_Ammonia":record.values.get("MW834", 0),
                    "Effluent_COD":record.values.get("MW833", 0)
                })
        ...
        # 保存为 CSV 文件
        df.to_csv('data/all_data_water_NEW.csv', index=False)
        print("数据已保存为 all_data_water_NEW.csv")
